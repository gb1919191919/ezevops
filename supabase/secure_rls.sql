...
-- Revoke public / anon execution permissions on internal security functions
REVOKE EXECUTE ON FUNCTION public.handle_new_user() FROM anon, public, authenticated;
REVOKE EXECUTE ON FUNCTION public.get_auth_profile_id() FROM anon, public;
...
-- Grant execute only to authenticated and service_role where needed for RLS
GRANT EXECUTE ON FUNCTION public.get_auth_profile_id() TO authenticated, service_role;
GRANT EXECUTE ON FUNCTION public.is_owner_or_manager() TO authenticated, service_role;
...
CREATE POLICY "auth_insert_hubs" ON public.hubs FOR INSERT TO authenticated WITH CHECK ((SELECT public.is_owner_or_manager()));
CREATE POLICY "auth_update_hubs" ON public.hubs FOR UPDATE TO authenticated USING ((SELECT public.is_owner_or_manager())) WITH CHECK ((SELECT public.is_owner_or_manager()));
CREATE POLICY "auth_delete_hubs" ON public.hubs FOR DELETE TO authenticated USING ((SELECT public.is_super_admin()));
...
CREATE POLICY "auth_delete_charger_logs" ON public.charger_logs FOR DELETE TO authenticated USING ((SELECT public.is_owner_or_manager()));

-- PROFILES
CREATE POLICY "auth_select_profiles" ON public.profiles FOR SELECT TO authenticated USING (true);
CREATE POLICY "auth_insert_profiles" ON public.profiles FOR INSERT TO authenticated WITH CHECK ((SELECT public.is_super_admin()) OR auth_user_id = (SELECT auth.uid()));
CREATE POLICY "auth_update_profiles" ON public.profiles FOR UPDATE TO authenticated USING ((SELECT public.is_super_admin()) OR auth_user_id = (SELECT auth.uid())) WITH CHECK ((SELECT public.is_super_admin()) OR auth_user_id = (SELECT auth.uid()));
CREATE POLICY "auth_delete_profiles" ON public.profiles FOR DELETE TO authenticated USING ((SELECT public.is_super_admin()));

-- ROLES & PROFILE_ROLES
CREATE POLICY "auth_select_roles" ON public.roles FOR SELECT TO authenticated USING (true);
CREATE POLICY "auth_insert_roles" ON public.roles FOR INSERT TO authenticated WITH CHECK ((SELECT public.is_super_admin()));
CREATE POLICY "auth_update_roles" ON public.roles FOR UPDATE TO authenticated USING ((SELECT public.is_super_admin())) WITH CHECK ((SELECT public.is_super_admin()));
CREATE POLICY "auth_delete_roles" ON public.roles FOR DELETE TO authenticated USING ((SELECT public.is_super_admin()));

CREATE POLICY "auth_select_profile_roles" ON public.profile_roles FOR SELECT TO authenticated USING (true);
CREATE POLICY "auth_insert_profile_roles" ON public.profile_roles FOR INSERT TO authenticated WITH CHECK ((SELECT public.is_super_admin()));
CREATE POLICY "auth_update_profile_roles" ON public.profile_roles FOR UPDATE TO authenticated USING ((SELECT public.is_super_admin())) WITH CHECK ((SELECT public.is_super_admin()));
CREATE POLICY "auth_delete_profile_roles" ON public.profile_roles FOR DELETE TO authenticated USING ((SELECT public.is_super_admin()));

-- VEHICLES & INSPECTIONS
CREATE POLICY "auth_select_vehicles" ON public.vehicles FOR SELECT TO authenticated USING (true);
CREATE POLICY "auth_insert_vehicles" ON public.vehicles FOR INSERT TO authenticated WITH CHECK ((SELECT public.is_owner_or_manager()));
CREATE POLICY "auth_update_vehicles" ON public.vehicles FOR UPDATE TO authenticated USING (true) WITH CHECK (true);
CREATE POLICY "auth_delete_vehicles" ON public.vehicles FOR DELETE TO authenticated USING ((SELECT public.is_super_admin()));
...
CREATE POLICY "auth_update_vehicle_inspections" ON public.vehicle_inspections FOR UPDATE TO authenticated USING ((SELECT public.is_owner_or_manager())) WITH CHECK ((SELECT public.is_owner_or_manager()));
CREATE POLICY "auth_delete_vehicle_inspections" ON public.vehicle_inspections FOR DELETE TO authenticated USING ((SELECT public.is_super_admin()));
...
CREATE POLICY "auth_insert_parts" ON public.parts FOR INSERT TO authenticated WITH CHECK ((SELECT public.is_owner_or_manager()));
CREATE POLICY "auth_update_parts" ON public.parts FOR UPDATE TO authenticated USING ((SELECT public.is_owner_or_manager())) WITH CHECK ((SELECT public.is_owner_or_manager()));
CREATE POLICY "auth_delete_parts" ON public.parts FOR DELETE TO authenticated USING ((SELECT public.is_super_admin()));
...
CREATE POLICY "auth_delete_hub_part_stock" ON public.hub_part_stock FOR DELETE TO authenticated USING ((SELECT public.is_owner_or_manager()));
...
CREATE POLICY "auth_update_part_usage_logs" ON public.part_usage_logs FOR UPDATE TO authenticated USING ((SELECT public.is_owner_or_manager())) WITH CHECK ((SELECT public.is_owner_or_manager()));
CREATE POLICY "auth_delete_part_usage_logs" ON public.part_usage_logs FOR DELETE TO authenticated USING ((SELECT public.is_super_admin()));
...
CREATE POLICY "auth_delete_job_cards" ON public.job_cards FOR DELETE TO authenticated USING ((SELECT public.is_owner_or_manager()));
...
CREATE POLICY "auth_delete_job_card_parts" ON public.job_card_parts FOR DELETE TO authenticated USING ((SELECT public.is_owner_or_manager()));
...
CREATE POLICY "auth_update_refunds" ON public.refunds FOR UPDATE TO authenticated USING ((SELECT public.is_owner_or_manager())) WITH CHECK ((SELECT public.is_owner_or_manager()));
CREATE POLICY "auth_delete_refunds" ON public.refunds FOR DELETE TO authenticated USING ((SELECT public.is_super_admin()));
...
CREATE POLICY "auth_delete_objectives" ON public.objectives FOR DELETE TO authenticated USING ((SELECT public.is_owner_or_manager()));
...
CREATE POLICY "auth_delete_milestones" ON public.milestones FOR DELETE TO authenticated USING ((SELECT public.is_owner_or_manager()));
...
CREATE POLICY "auth_delete_tasks" ON public.tasks FOR DELETE TO authenticated USING ((SELECT public.is_owner_or_manager()));
...
CREATE POLICY "auth_delete_task_remarks" ON public.task_remarks FOR DELETE TO authenticated USING ((SELECT public.is_owner_or_manager()));
...
CREATE POLICY "auth_delete_task_attachments" ON public.task_attachments FOR DELETE TO authenticated USING ((SELECT public.is_owner_or_manager()));
...
CREATE POLICY "auth_delete_task_changelog" ON public.task_changelog FOR DELETE TO authenticated USING ((SELECT public.is_super_admin()));
...
CREATE POLICY "auth_delete_daily_shift_logs" ON public.daily_shift_logs FOR DELETE TO authenticated USING ((SELECT public.is_owner_or_manager()));
...
CREATE POLICY "auth_delete_chat_channels" ON public.chat_channels FOR DELETE TO authenticated USING ((SELECT public.is_owner_or_manager()));

-- SOPS & REVISIONS
CREATE POLICY "auth_select_sops" ON public.sops FOR SELECT TO authenticated USING (true);
CREATE POLICY "auth_insert_sops" ON public.sops FOR INSERT TO authenticated WITH CHECK ((SELECT public.is_owner_or_manager()));
CREATE POLICY "auth_update_sops" ON public.sops FOR UPDATE TO authenticated USING ((SELECT public.is_owner_or_manager())) WITH CHECK ((SELECT public.is_owner_or_manager()));
CREATE POLICY "auth_delete_sops" ON public.sops FOR DELETE TO authenticated USING ((SELECT public.is_super_admin()));

CREATE POLICY "auth_select_sop_revisions" ON public.sop_revisions FOR SELECT TO authenticated USING (true);
CREATE POLICY "auth_insert_sop_revisions" ON public.sop_revisions FOR INSERT TO authenticated WITH CHECK ((SELECT public.is_owner_or_manager()));
CREATE POLICY "auth_update_sop_revisions" ON public.sop_revisions FOR UPDATE TO authenticated USING ((SELECT public.is_owner_or_manager())) WITH CHECK ((SELECT public.is_owner_or_manager()));
CREATE POLICY "auth_delete_sop_revisions" ON public.sop_revisions FOR DELETE TO authenticated USING ((SELECT public.is_super_admin()));
...
CREATE POLICY "auth_delete_team_notes" ON public.team_notes FOR DELETE TO authenticated USING ((SELECT public.is_owner_or_manager()));

-- BLOCKED USERS
CREATE POLICY "auth_select_blocked_users" ON public.blocked_users FOR SELECT TO authenticated USING (true);
CREATE POLICY "auth_insert_blocked_users" ON public.blocked_users FOR INSERT TO authenticated WITH CHECK ((SELECT public.is_owner_or_manager()));
CREATE POLICY "auth_update_blocked_users" ON public.blocked_users FOR UPDATE TO authenticated USING ((SELECT public.is_owner_or_manager())) WITH CHECK ((SELECT public.is_owner_or_manager()));
CREATE POLICY "auth_delete_blocked_users" ON public.blocked_users FOR DELETE TO authenticated USING ((SELECT public.is_super_admin()));

-- AUDIT LOGS
CREATE POLICY "auth_select_audit_logs" ON public.audit_logs FOR SELECT TO authenticated USING ((SELECT public.is_super_admin()));
CREATE POLICY "auth_insert_audit_logs" ON public.audit_logs FOR INSERT TO authenticated WITH CHECK (true);
CREATE POLICY "auth_update_audit_logs" ON public.audit_logs FOR UPDATE TO authenticated USING ((SELECT public.is_super_admin())) WITH CHECK ((SELECT public.is_super_admin()));
CREATE POLICY "auth_delete_audit_logs" ON public.audit_logs FOR DELETE TO authenticated USING ((SELECT public.is_super_admin()));
